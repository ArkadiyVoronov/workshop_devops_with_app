...
> Примечание: часть переменных в `.env.example` зарезервирована под дополнительные сценарии (frontend-ошибки, security и т.д.). В текущей версии воркшопа они не используются в `app.py` и приведены для будущих расширений.
---
